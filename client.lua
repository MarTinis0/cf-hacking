...
RegisterCommand('MemoryGame', function()
    ...
    local success = exports['cf-Hacking']:MemoryGame(3, 2, 10000)
    if success then
        print("success")
    else
        print("fail")
...
RegisterCommand('NumberUp', function()
    ...
    local success = exports['cf-Hacking']:NumberUp(28, 2, 2, 40000, 20000)
    if success then
        print("success")
    else
        print("fail")
...
RegisterCommand('SkillCheck', function()
    ...
    local success = exports['cf-Hacking']:SkillCheck(50, 5000, {'w','a','s','w'}, 2, 20, 3)
    if success then
        print("success")
    else
        print("fail")
...
RegisterCommand('Thermite', function()
    ...
    local success = exports['cf-Hacking']:Thermite(7, 5, 10000, 2, 2, 3000)
    if success then
        print("success")
    else
        print("fail")
...
RegisterCommand('SkillBar', function()
    ...
    local success = exports['cf-Hacking']:SkillBar({2000, 3000}, 10, 2)
    if success then
        print("success")
    else
        print("fail")
...
RegisterCommand('ShowNumber', function()
    ...
    exports['cf-Hacking']:ShowNumber(999, 3000)
end)

RegisterCommand('KeyPad', function()
                                        --KeyPad(code(number), time(milliseconds))
    local success = exports['cf-Hacking']:KeyPad(999, 3000)
    if success then
        print("success")
    else
        print("fail")
...
local success = exports['cf-Hacking']:ColorPicker(3, 7000, 3000)
    if success then
        print("success")
    else
        print("fail")
...
local success = exports['cf-Hacking']:MemoryCards('medium')
    if success then
        print("success")
    else
        print("fail")
...
local multiplier = exports['cf-Hacking']:Mines(5, 3, 9, 1)
    if multiplier then
        print(multiplier)
    else
        print("fail")
